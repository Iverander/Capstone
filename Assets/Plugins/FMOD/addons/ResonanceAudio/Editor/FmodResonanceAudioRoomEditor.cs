...
namespace FMODUnityResonance
{
    ...
    {
        private static readonly string[] SurfaceMaterialDisplay =
        {
            L10n.Tr("Transparent"),
        ...
        private static readonly int[] SurfaceMaterialValues =
        {
        ...
        private void DrawSurfaceMaterial(SerializedProperty surfaceMaterial, string displayName)
        {
            ...
            var labelContent = new GUIContent(displayName, surfaceMaterialLabel.tooltip);
