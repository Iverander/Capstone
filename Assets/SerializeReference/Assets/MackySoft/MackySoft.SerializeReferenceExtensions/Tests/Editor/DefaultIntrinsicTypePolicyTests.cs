    ...
    public sealed class DefaultIntrinsicTypePolicyTests
    {
        public static IEnumerable<TestCaseData> Cases ()
        {
            yield return new TestCaseData(typeof(PublicSerializableClass), true).SetName(
                "Intrinsic_PublicSerializableClass_OK");
            ...
            yield return new TestCaseData(typeof(NonSerializableClass), false).SetName(
                "Intrinsic_NoSerializableAttribute_NG");
            yield return
                new TestCaseData(typeof(HiddenSerializableClass), false).SetName("Intrinsic_HideInTypeMenu_NG");
