...
namespace MackySoft.SerializeReferenceExtensions.Tests
{
    ...
    {
        public static Type NestedPrivateType =>
            typeof(Outer).GetNestedType(nameof(NestedPrivateSerializableClass), BindingFlags.NonPublic);
