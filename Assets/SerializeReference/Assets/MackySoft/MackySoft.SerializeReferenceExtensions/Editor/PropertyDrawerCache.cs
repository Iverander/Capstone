...
namespace MackySoft.SerializeReferenceExtensions.Editor
{
    ...
    {
        private static readonly Dictionary<Type, PropertyDrawer> Caches = new();
        ...
        private static Type GetCustomPropertyDrawerType (Type type)
        {
            ...
            {
                object[] customPropertyDrawerAttributes =
                ...
                foreach (CustomPropertyDrawer customPropertyDrawer in customPropertyDrawerAttributes)
                {
                    ...
                    if (field != null)
                    {
                        ...
                        if (fieldType != null)
                        {
                            ...
                            FieldInfo useForChildrenField = customPropertyDrawer.GetType().GetField("m_UseForChildren",
