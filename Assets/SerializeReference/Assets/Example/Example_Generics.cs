...
public class Example_Generics : MonoBehaviour
{
    ...
    public IContravarianceAction<INetworkActor> contravarianceAction;

    [SerializeReference] [SubclassSelector]
    public BaseAction<IActor> baseAction;

    [SerializeReference] [SubclassSelector]
    public List<IContravarianceAction<INetworkActor>> contravarianceActions = new();

    [SerializeReference] [SubclassSelector]
    public List<ICovarianceAction<INetworkActor>> covarianceActions = new();
}