...
void Ripples(float2 uv, float angleOffset, float cellDensity, float time, float strength, out float Out,
             out float3 Normal)
{
...
void Ripples_float(float2 uv, float angleOffset, float cellDensity, float time, float strength, out float Out,
                   out float3 Normal)
{
