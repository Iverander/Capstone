...
namespace Capstone
{
    ...
    public class Enemy : Creature
    {
        ...
        public List<Ability> abilities = new(); //things has been simplified, you're welcome

        private int abilityToPreform;
        ...
        private IEnumerator Attack()
        {
            ...
            abilities[abilityToPreform]
                .Perform(); //preforms chosen ability, towards player creature (no longer towards a player creature as we use layers instead now like any good citizen)
