...
namespace Capstone
{
    ...
    {
        [Header("Stats")] [SerializeField] protected float force;

        [InfoBox("Zero is adaptive :)")] [SerializeField]
        ...
        {
            var directionVector = direction;
            if (directionVector == Vector3.zero) directionVector = Player.instance.movement.ConvertedDirection;
